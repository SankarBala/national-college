...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Achivement add</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Entry Achivement</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-success">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select id="inputStatus" class="form-control custom-select" name="status">
                                            <option value="published" checked>Published</option>
                        ...
                        <div class="row p-4">
                            <div class="col-12">
                                ...
                                <input type="submit" value="Publish Achivement" class="btn btn-success float-right">
                            </div>
                        </div>
                    </div>
                    <!-- /.card -->
